...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Kunal dhoke
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">i am a 'WEB DEVELOPER'
                 currently studying in BCA and pursuing some skiils and i'm 
                 enthusiast for passion.
            </p>
